...
export const routes: Routes = [
  ...
  { path: 'orders', title: 'order', component: OrdersComponent },
  { path: 'products', title: 'products', component: ProductsComponent },
  { path: 'create', title: 'create product', component: AddProductComponent },
  {
    path: 'home',
    title: 'Home',
  ...
  //       loadComponent: () =>
  //         import('./update-category/update-category.component').then(
  ...
  //       loadComponent: () =>
  //         import('./add-subcategory/add-subcategory.component').then(
  ...
  //       loadComponent: () =>
  //         import('./update-subcategory/update-subcategory.component').then(
